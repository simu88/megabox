...
<form action="EnrollNewMovie.jsp" method="post" enctype="multipart/form-data">
	<div style="display:flex">
		...
		<input type=button value="신규 등록" style="width: 100px;height: 40px;" onclick="location.href='managerEnrollNewMovie.jsp'">
        ...
        <td>
	  	...
	  	<div style="width:400px; height:200px; margin-left:55%; margin-top:35%;">
	 		<button type="submit" "width: 100px;height: 40px;">다음</button>
	  	</div>
	  	</form>
	</div>	
	</div>
